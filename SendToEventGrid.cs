...
namespace TollBooth
{
    public class SendToEventGrid
    {
        ...
        public async Task SendLicensePlateData(LicensePlateData data)
        {
            ...
            {
                // TODO 3_done: Modify send method to include the proper eventType name value for saving plate data.
                // COMPLETE: await Send(...);
                await Send("savePlateData", "TollBooth/CustomerService", data);
            }
            else
            {
                // TODO 4_done: Modify send method to include the proper eventType name value for queuing plate for manual review.
                // COMPLETE: await Send(...);
